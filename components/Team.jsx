...
const teamItems = [
  {
    image: "/al-ali-bin-mughees.webp",
    name: "Al Ali Bin Mughees",
    profession: "Co-Founder and Head of Client Support and Operations",
    facebookLink: "/#",
    twitterLink: "/#",
    instagramLink: "/#",
  },
  {
    image: "/saad-malik.webp",
    name: " Saad Malik",
  ...
  {
    image: "/hannad-sajid.webp",
    name: "Hannad Sajid",
    profession: " Head of Client Support and Virtual Assistant Services",
    facebookLink: "/#",
    twitterLink: "/#",
    instagramLink: "/#",
  },
...
const Team = () => {
  return (
    <>
      <section className="overflow-hidden bg-tg-bg pb-10 pt-10 dark:bg-dark-2">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                <span className="mb-2 block text-lg font-semibold text-[#933DE6]">
                  Our Team Members
                </span>
              ...
              >
                <div className="group mb-8 rounded-[5px] bg-white px-5 pb-10 pt-12 shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
                  <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                    ...
                    />
                    <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-[#933DE6] opacity-0 transition-all group-hover:opacity-100"></span>
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-5">
                      <Link
                        ...
                        className="text-dark-8 hover:text-[#933DE6]"
                      >
                        <svg
                          width="18"
                          height="18"
