            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="-mx-3 flex items-center">
                  <Link
                    href="#"
                    className="px-3 text-dark-7 hover:text-[#933DE6] dark:text-white/40"
                  >
                    <svg
                      width="10"
                      height="18"
                  ...
                  <ul className="space-y-3">
                    {group.items.map((item, index) => (
                      <li key={index}>
                        <Link
                          href={item.link}
                          className="inline-block text-base leading-loose text-body-color hover:text-[#933DE6] dark:text-dark-6"
                        >
                          {item.text}
                        </Link>
                      </li>
              ...
              <div className="mb-10 w-full">
                ...
                {/* <form className="relative mb-5 w-full overflow-hidden rounded">
                  <input
                    ...
                    className="h-12 w-full rounded border border-stroke bg-transparent px-5 text-sm text-body-color outline-none focus:border-[#933DE6] focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
                  />
                  <button
                    type="submit"
                    className="absolute right-0 top-0 flex h-full w-12 items-center justify-center bg-[#933DE6] text-white hover:bg-opacity-90"
                  >
                    <svg
                      width="20"
                      height="20"
